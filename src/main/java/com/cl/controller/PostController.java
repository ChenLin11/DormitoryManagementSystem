...
import com.cl.service.PostService;
...
public class PostController {
    ...
    public R page(@RequestParam Map<String, Object> params, PostEntity forum, HttpServletRequest request){
		...
		PageUtils page = postService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, forum), params), params));
    ...
    public R flist(@RequestParam Map<String, Object> params, PostEntity forum, HttpServletRequest request){
        EntityWrapper<PostEntity> ew = new EntityWrapper<PostEntity>();
    	PageUtils page = postService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.allEq(ew, forum), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R query(PostEntity forum){
		...
		PostView forumView =  postService.selectView(ew);
    ...
    public R info(@PathVariable("id") Long id){
        PostEntity forum = postService.selectById(id);
	...
	private PostEntity getChilds(PostEntity forum) {
    	...
    	childs = postService.selectList(new EntityWrapper<PostEntity>().eq("parentid", forum.getId()));
    ...
    public R update(@RequestBody PostEntity forum, HttpServletRequest request){
        //ValidatorUtils.validateEntity(forum);
        postService.updateById(forum);//全部更新
        return R.ok();
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		int count = postService.selectCount(wrapper);
